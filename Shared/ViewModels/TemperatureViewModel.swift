...
{
    @Published var convertedTemperature = Temperature()
    ...
    func convertTemperature(numberOfUnit: String, inputUnit: Int, outputUnit: Int)
    {
        ...
        {
            convertedTemperature.temperature = String((numberOfUnits * 9/5) + 32)
        }
        else if inputUnit == 0 && outputUnit == 2
        {
            convertedTemperature.temperature = String(numberOfUnits + 273.15)
        }
        else if inputUnit == 1 && outputUnit == 0
        {
            convertedTemperature.temperature = String((numberOfUnits - 32) * 5/9)
        }
        else if inputUnit == 1 && outputUnit == 2
        {
            convertedTemperature.temperature = String((numberOfUnits - 32) * 5/9 + 273.15)
        }
        ...
        {
            convertedTemperature.temperature = String((numberOfUnits - 273.15) * 5/9 + 32)
        }
        print(convertedTemperature.temperature)
    }
}
